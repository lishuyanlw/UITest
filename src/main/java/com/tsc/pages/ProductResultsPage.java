...
public class ProductResultsPage extends BasePage {
	...
	//Selected filters
	//Second xpath works for mobile,ipad and desktop
//	@FindBy(xpath = "//div[contains(@class,'search-filters-div')]//div[contains(@class,'sortFilterWrap')]//div[contains(@class,'filterPrpLabel')]")
	@FindBy(xpath = "//product-results//div[contains(@class,'sortFilterWrap')]//div[contains(@class,'filterPrpLabel')]")
	...
	//@FindBy(xpath = "//product-results//div[@class='modalBody']//div[@class='panel']//*[contains(@class,'panel-heading')]//span | //product-results//div[@id='tabletFilterBar']//*[contains(@class,'panel-heading')]//span")
	List<WebElement> productFilterList;

	//Added OR condition works for iPad and desktop
	//for mobile there's no option as see more or see less
	@FindBy(xpath = "//product-results//div[@class='modalBody']//div[@class='panel']//*[contains(@class,'panel-heading')]/following-sibling::div[contains(@class,'panel-collapse')]//div[contains(@class,'seeMoreDiv') and not(contains(@class,'seeMoreTitle')) and not(@style='display: none;')][@id] | .//span[contains(.,'See More')]/parent::div[not(@aria-expanded)]")
	List<WebElement> productFilterMoreButtonList;

	//xpath works for both iPad and desktop
	//no button for mobile
	...
	@FindBy(xpath = "//div[contains(@class,'seeMoreDiv') and not(contains(@class,'seeMoreTitle')) and @aria-expanded='true' and not(@style='display: none;')]")
	List<WebElement> productFilterLessButtonList;

	//Added OR condition iPad
	@FindBy(xpath = "//product-results//div[@class='modalBody']//div[@class='panel'] | //product-results//div[@id='tabletFilterBar']//popper-content")
	List<WebElement> productFilterContainerList;

	//added OR condition for iPad
	@FindBy(xpath = "//product-results//div[@class='modalBody']//div[@class='panel']//li//div[not(contains(@class,'checked'))] | //product-results//div[@class='panel']//li//div[not(contains(@class,'checked'))]")
   ...
   //Added OR condition for iPad
	public By byMoreButtonOnLeftPanel = By.xpath(".//*[contains(@class,'panel-heading')]/following-sibling::div[contains(@class,'panel-collapse')]//div[contains(@class,'seeMoreDiv') and not(contains(@class,'seeMoreTitle')) and not(@style='display: none;')][@id] | .//span[contains(.,'See More')]/parent::div[not(@aria-expanded)]");

	//Added OR condition for iPad
	public By byLessButtonOnLeftPanel = By.xpath(".//*[contains(@class,'panel-heading')]/following-sibling::div[contains(@class,'panel-collapse')]//div[contains(@class,'seeMoreDiv') and not(contains(@class,'seeMoreTitle')) and @aria-expanded='true' and not(@style='display: none;')] | .//span[contains(.,'See Less')]/parent::div[@aria-expanded='true']");

	//new xpath works for both iPad and desktop
	...
	public By byMoreOrLessButtonOnLeftPanel = By.xpath(".//span[contains(.,'See More')]/parent::div[not(@aria-expanded)]|.//span[contains(.,'See Less')]/parent::div[@aria-expanded='true']");

	public By bySubItemListOnLeftPanel = By.xpath(".//li");

	//Added OR condition for iPad
	public By bySubItemPanelBodyOnLeftPanel=By.xpath(".//div[@class='panel-body'] | .//div[contains(@class,'ngxp__inner')]/div[@role='tabpanel']/div");
	...
	public List<WebElement> getSearchDropdownResultList(String lsKeyword) {
		...
		waitForCondition(Driver -> {
			return globalHeader.ctnSearchResult.getAttribute("class").contains("suggestions-container--open");
		}, 60000);
		...
		this.secondLevelFilter = lsSecondLevelItem;
			...
			for (int i = 0; i < loopSize; i++) {
				...
				if (lsHeader.equalsIgnoreCase(lsFirstLevelItem)) {
					//if((devListTab.contains(devNameTab))||(devListMob.contains(devNameMob))){}
					...
					//if((devListTab.contains(devNameTab))||(devListDesktop.contains(devNameDesktop))){}
			...
			//Added OR condition works for all devices
