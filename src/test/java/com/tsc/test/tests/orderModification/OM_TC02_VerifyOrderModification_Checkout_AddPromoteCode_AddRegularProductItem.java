...
public class OM_TC02_VerifyOrderModification_Checkout_AddPromoteCode_AddRegularProductItem extends BaseTest {
    /*
     * CER-905
     */
    @Test(groups={"Regression","OrderModification"})
    public void OM_TC02_VerifyOrderModification_Checkout_AddPromoteCode_AddRegularProductItem() throws IOException {
