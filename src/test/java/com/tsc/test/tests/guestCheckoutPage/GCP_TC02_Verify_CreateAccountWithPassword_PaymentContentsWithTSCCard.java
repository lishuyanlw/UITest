...
public class GCP_TC02_Verify_CreateAccountWithPassword_PaymentContentsWithTSCCard extends BaseTest{
	/*
	 * CER-899
	 * CER-900
	 * CER-901
	...
	public void GCP_TC02_Verify_CreateAccountWithPassword_PaymentContentsWithTSCCard() throws IOException {
		...
		if(getProductDetailPageThreadLocal().goToProductItemWithPreConditions(lstKeywordList,"ConditionsForMultipleStyleAndSize",outputDataCriteria)) {
			...
			Map<String,Object> createdUserMap=getGuestCheckoutThreadLocal().createNewAccount(null,null,true);
